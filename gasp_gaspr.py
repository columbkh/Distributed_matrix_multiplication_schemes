from gasp_vs_gaspr import *


def do_multiple_tests(r_a, r_b, l, r, field, q, m, n, p, verific, together, number, coeff):
    write_title_to_octavemnp(q, field, m, n, p, number, coeff)
    set_communicators_gasp_gaspr(r_a, r_b, l, r, field)
    ...
    for i in range(number):
        if MPI.COMM_WORLD.rank == 0:
            ...
            print "p: ", p
            print "--------------------------------------------------------------------------"
        do_test(r_a, r_b, l, r, field, q, m, n, p, verific, together)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--r', type=int, help='parameter for GASPr')
    ...
    do_multiple_tests(r_a, r_b, l, r, field, q, m, n, p, verific, together, number, coeff)
